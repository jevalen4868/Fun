...
int Fight(int type)
{
    ...
    if (ninjaAction == 0){
        ...
        while(ninjaHealth > 0){
            ...
            // Use playerAction = 0 for keeping in the loop until ready.
            while(playerAction != 1
                ...
                printf("(4) Use Potion! Restores %d health\n", potionHealth);
                ...
                if( potionNum < 1 && playerAction == 4)
                {
                    printf("You are out of potions, tough luck...\n");
                    playerAction = 0;
                }
                
                if ((playerAction != 1 && playerAction != 2 && playerAction != 3 && playerAction != 4 && playerAction != 'q' && playerAction != 'Q')){ //|| (/*player presses any other key*/)){
            ...
            switch(playerAction){
                ...
                case 4 : pizzaHealth += potionHealth;
                    ...
                    potionNum --; // potionNum = potionNum - 1;
