...
int Fight()
{
	...
	int randTopping = 0;				//Random variable to determine Topping
	int stage1 = 0;						//First part of narrative
	int stage2 = 0;						//Second part of narrative
	int ninjaAction = 0;				//What the monster does
	...
	if (ninjaAction == 0){
		...
		while(ninjaHealth > 0){
			...
			while(playerAction != 1 && playerAction != 2 && playerAction != 3){
...
//				playerAction = (int) playerActionInput;
				...
				if ((playerAction != 1 && playerAction != 2 && playerAction != 3 && playerAction != 'q' && playerAction != 'Q')){ //|| (/*player presses any other key*/)){
